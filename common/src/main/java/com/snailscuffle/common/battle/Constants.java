...
public class Constants {
	...
	public static final int ATTACK_BOOST_DURATION = 4000;
	public static final double DEFENSE_BOOST_MULTIPLIER = 1.4;
	public static final int DEFENSE_BOOST_DURATION = 4000;
	public static final int SPEED_BOOST_AP_INCREASE = 15;
